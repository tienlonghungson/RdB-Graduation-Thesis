In this section, we introduce a labeled graph to represent $(k,s)$-RdB sequences, called $(k,s)$-RdB graph. Just like a de Bruijn graph of order $k$, any simple path in $(k,s)$-Rdb graph represents a $(k,s)$-RdB sequence.
