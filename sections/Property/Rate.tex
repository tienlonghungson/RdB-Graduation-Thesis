...
Having the explicit formula of the length of sequence $\bfc_{k,s}$ determined makes it easier to calculate the maximal asymptotic rate of the $(k,s)$-RdB sequence.
